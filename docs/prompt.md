...
- reference/old_php/ 该目录内有大量php旧代码可以参考 
- reference/python_sdk_v8.2.0/ 是金蝶官方提供的SDK，建议这个项目直接使用
- reference/python_sdk_demo/ SDK demo
- reference/connection_env.md 是一个可以直接进行端到端测试的金蝶测试接口 
- reference/KingdeeCloud/apis_list.json
- reference/KingdeeCloud/details/ 有每个接口完整的地址 
...
金蝶云星空的 接口非常特殊
另外一个爬虫 已经成功爬取了所有接口，他的实现形式 你可以阅读并且参考：
- /home/vincent/workspace/other/api-asset-crawler/crawlers/KingdeeCloud
- /home/vincent/workspace/other/api-asset-crawler/crawlers/KingdeeCloud/BATCH_CRAWL_GUIDE.md

请注意 当前项目是为 qdatav2 开发通用性适配器 